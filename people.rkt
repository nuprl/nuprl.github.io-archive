...
MS Stanford University 1995<br />
          ...
          <div class="row pn-person">
            <div class="col-md-12 pn-row-eq-height">
              <div class="col-md-3 pn-photo">
                <div class="img-wrapper">
                  <img src="img/frank_tip.jpg" title="Frank Tip" alt="Frank Tip" />
                </div>
              </div>
              <div class="col-md-9">
                <div class="col-md-4 pn-contact">
                  <span class="pn-name">Frank Tip</span><br />
                  Professor<br />
                  <a href="mailto:tip@"@"acm.org">tip@"@"acm.org</a><br />
                  <a href="http://www.franktip.org/">http://www.franktip.org/</a>
                </div>
                <div class="col-md-5 pn-muted col-md-offset-3">
Joined Northeastern, 2016 <br />
Joined Samsung Research America, 2014<br />
Joined University of Waterloo, 2012<br />
Joined IBM T.J. Watson Research Center, 1995<br />
PhD University of Amsterdam, 1995<br />
                </div>
                <div class="col-md-12 pn-bio">
                  <p>My research is in the areas of Programming Languages and Software Engineering and is focused on the use of program analysis in tools that help increase programmer productivity and software quality. Specific topics that I've worked on in recent years include tools for detecting and localizing bugs, refactoring, test generation, and optimization.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row pn-person">
            <div class="col-md-12 pn-row-eq-height">
              <div class="col-md-3 pn-photo">
                <div class="img-wrapper">
                  <img src="img/heather_miller.jpg" title="Heather Miller" alt="Heather Miller" />
                </div>
              </div>
              <div class="col-md-9">
                <div class="col-md-4 pn-contact">
                  <span class="pn-name">Heather Miller</span><br />
                  Assistant Professor<br />
                  <a href="mailto:heather@"@"ccs.neu.edu">heather@"@"ccs.neu.edu</a><br />
                  <a href="http://heather.miller.am">http://heather.miller.am</a>
                </div>
                <div class="col-md-5 pn-muted col-md-offset-3">
                    Joined Northeastern, 2016<br />
                    PhD, EPFL, 2015<br />
...
I work on the intersection of programming languages and distributed systems. I am a member of the Scala team, and have worked on Scala's concurrency libraries including Scala's futures and promises library, and compile-time support for distributed programs. Much of my work is focused on transferring research results into practical use. Before joining Northeastern, I co-founded and served as the executive director of a new center at EPFL for research, education, and open source development surrounding the Scala programming language, called the Scala Center. </p>
          ...
          <div class="row pn-person">
            <div class="col-md-12 pn-row-eq-height">
              <div class="col-md-3 pn-photo">
                <div class="img-wrapper">
                  <img src="img/fillip_krikava.jpg" title="Fillip Krikava" alt="Fillip Krikava" />
                </div>
              </div>
              <div class="col-md-9">
                <div class="col-md-4 pn-contact">
                  <span class="pn-name">Fillip Krikava</span><br />
                  Post-doctoral researcher<br />
                  <a href="mailto:f.krikava@"@"neu.edu">f.krikava@"@"neu.edu</a><br />
                  <a href="http://fikovnik.net">http://fikovnik.net</a>
                </div>
                <div class="col-md-5 pn-muted col-md-offset-3">
                    Joined Northeastern, 2016<br />
                    Joined INRIA Lille, 2013<br />
                    PhD, University of Nice Sophia-Antipolis, 2013
                </div>
                <div class="col-md-12 pn-bio">
                  <p>Coming from software engineering and domain-specific modeling. I’m interested in various aspects of programming languages in particular in static and dynamic program analysis. Most recently I have been working on dynamic tracing in R.
</p>
                </div>
              </div>
            </div>
